...
public class liststoreChicken extends ActionBarActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_liststore_chicken);

        String[] store={"Bonchon", "Shakey's", "Mcdonalds"};
        ...
        displayView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (choice == "Bonchon") {
                    ...
                    Intent intent = new Intent(getApplicationContext(), storeInfoShakeys.class);
                    startActivity(intent);
                } else if (choice == "Mcdonalds") {
                    Intent intent = new Intent(getApplication(), storeInfoMcdo.class);
                    startActivity(intent);
                }
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.liststore_chicken, menu);
        return true;
    }
